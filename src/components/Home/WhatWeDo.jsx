	...
	return (
		<div className="mt-8">
			<motion.section
				...
				className="flex flex-col items-center justify-center py-10 sm:py-14 lg:py-16  px-4 bg-gradient-to-r bg-[#fdfd96]  dark:bg-[#111827]  animate-gradient-x"
			>
				{/* Wrapping the section in motion.div for fade-in effect */}
				<motion.div
					initial="hidden"
				...
				>
					{/* Main Heading */}
					<motion.h1
						className="text-center text-3xl sm:text-4xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-4"
						variants={headingVariants}
					>
						Finding a new way!
					</motion.h1>
					...
					{/* Subheading */}
					<motion.h2
						className="text-center text-2xl sm:text-3xl lg:text-3xl font-bold text-[#27A744] dark:text-[#855BFF]"
