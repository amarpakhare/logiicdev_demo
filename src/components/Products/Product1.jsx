          ...
          <span className="absolute left-3 md:left-10 top-1/2 transform -translate-y-1/2 text-purple-500">
			...
			>
				<div className="relative text-center max-w-4xl">
					{/* Top decorative line */}
					<div className="absolute top-0 left-0 right-0 h-2 bg-[#ffcc00] mx-auto "></div>
					...
					<div className="absolute bottom-0 left-0 right-0 h-2 bg-[#ffcc00] mx-auto "></div>
					<div className="absolute bottom-1 left-0 right-0 h-2 bg-[#0c8ce9] mx-auto w-1/2"></div>
				</div>
			</motion.div>
			{/* <motion.div
			...
			{/* OmniPower Diagram */}
			{/* <motion.div
				className="flex flex-col items-center justify-evenly min-h-60 md:min-h-76  md:py-20 sm:p-10 rounded-lg"
				ref={refe9}
				initial="hidden"
			...
			<section className="flex flex-col lg:flex-row items-center justify-between p-8 sm:p-16 sm:m-10 lg:gap-24">
				...
				>
					<img
						src={PositiveImpactOmniPower} // Replace with your image path
				...
				<motion.div
					className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-left lg:pl-16"
					ref={refe5}
					initial="hidden"
			...
			{/* <motion.section
				className="flex flex-col lg:flex-row items-center justify-between p-8 sm:p-16 sm:m-10 max-w-[1600px]"
				ref={refe7}
				initial="hidden"
			...
			>
				...
				<motion.div
					...
					variants={textVariants}
				>
					<span className="bg-[#ffcc00] text-black dark:bg-[#F0F8EE] dark:text-[#1D6362] font-semibold px-3 py-1 rounded-full text-xs sm:text-sm inline-block mb-4">
						Industry Focus
					</span>
					...
					<h1
						...
						whileHover="hover"
					>
						The Strategic Role of Testing in Battery Innovation
					</h1>
