				...
				<div className="max-w-full mx-auto px-6 lg:px-8">
					...
					>
						...
						<div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
							<div className="flex items-center mb-4">
								...
								<h3 className="text-2xl font-semibold">
									Tailored Simulation & AI Testing
								</h3>
							</div>
							<p className="text-gray-700 dark:text-gray-300">
								Project-specific platforms designed to meet unique needs in
								simulation and AI testing.
							</p>
						</div>
						...
						<div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
							...
							<p className="text-gray-700 dark:text-gray-300">
								Researching and integrating new technologies to keep you ahead
								in the industry.
							</p>
						</div>
						...
						<div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
							...
							<p className="text-gray-700 dark:text-gray-300">
								Skilled engineers specializing in simulation modeling, AI
								testing, ML, and data analysis.
							</p>
						</div>
					</motion.div>
					<motion.p
