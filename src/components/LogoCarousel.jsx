	...
	return (
		<>
			<div className="overflow-hidden py-8 bg-white dark:bg-[#111827]">
				<h2 className="text-center text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-4">
					Trusted By Customers Worldwide
				</h2>
				<div className="flex justify-center">
					<div className="flex space-x-4 sm:space-x-8 animate-scroll flex-wrap justify-center">
