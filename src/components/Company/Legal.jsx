					...
					<div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center text-gray-800">
						...
						<div className="space-y-4">
							...
							<p className="text-sm md:text-base dark:text-white">
								...
								confidential information of Logiicdev, its representatives, and
								is intended solely for the use of the individual or entity to
								which it is addressed. Any unauthorized review, use, disclosure
								or distribution is prohibited. If you believe this message was
								sent to you in error, please immediately notify the sender by
								reply email and delete this message without disclosing it. Thank
								you.
								<br />
								<br />
								If you have any questions about this disclaimer, please mail us
								at contact@logiicdev.eu
							</p>
						</div>
						...
						<div className="space-y-4">
							...
							<hr className="w-10 mx-auto border-gray-300" />
							<p className="text-sm md:text-base dark:text-white">
								We have tried our best to avoid any kind of misconduct.
								Logiicdev is not responsible for the translation errors on the
								site.
							</p>
						</div>
					</div>
